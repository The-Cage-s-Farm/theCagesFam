...
class PuzzleScene: SKScene {
    ...
    func initicialDrawing() {
        ...
        semicircleOne.position = CGPoint(x: frame.midX, y: frame.midY)
        ...
        semicircleTwo.position = CGPoint(x: frame.midX, y: frame.midY)
        ...
        semicircleThree.position = CGPoint(x: frame.midX, y: frame.midY)
        ...
        semicircleFour.position = CGPoint(x: frame.midX, y: frame.midY)
